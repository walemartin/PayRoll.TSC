...
namespace PayRoll.TSC.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Leave,NoOfDaysAnnually")] LeaveType leaveType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Leave,NoOfDaysAnnually")] LeaveType leaveType)
        {
            if (id != leaveType.Id)
            {
                return NotFound();
