...
namespace PayRoll.TSC.Controllers
{
    public class BankBranchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Bank")] BankBranch bankBranch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Bank")] BankBranch bankBranch)
        {
            if (id != bankBranch.ID)
            {
                return NotFound();
