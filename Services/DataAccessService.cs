...
namespace PayRoll.TSC.Services
{
	public class DataAccessService : IDataAccessService
	{
		...
		//Task<List<NavigationMenuViewModel>> IDataAccessService.GetMenuItemsAsync(ClaimsPrincipal principal)
		//{
		//	throw new NotImplementedException();
		//}

		//Task<List<NavigationMenuViewModel>> IDataAccessService.GetPermissionsByRoleIdAsync(string? id)
		//{
		//	throw new NotImplementedException();
		//}
	}
